...
* The original package name 'com.spring.security.examples.spring-security-app1' is invalid and this project uses 'com.spring.security.examples.springsecurityapp1' instead.
